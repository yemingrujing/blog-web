...
import {
  Row, Col, Menu, Drawer, Modal, Input, List, Avatar, message,
} from 'antd';
import {
  HomeOutlined,
  SearchOutlined,
    ...
    <HeaderBox isUp={isUp}>
      ...
      <Row justify="space-around">
        <Col xs={16} sm={6} className="logo">
          <Row>
            <Col xs={0} sm={4}><Avatar size="large" src="/image-base-url/blog/common/1611626314508.png" /></Col>
            <Col xs={24} sm={20}>
      ...
      >
        <Search
          ...
          allowClear
          onChange={(e) => {
            console.log('关键字模糊搜索：{}', e.target.value);
